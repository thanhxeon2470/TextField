...
function TextField(props) {
    ...
    const inp = "w-full flex flex-col justify-center items-start px-4 py-2 static top-45.45 right-0 bottom-0 left-0 bg-transparent border border-solid border-blue-356 box-border rounded-lg flex-none order-1 self-stretch flex-grow-0 my-2 hover:border-blue-18A active:border-blue-DAF placeholder-blue-A83 font-inter not-italic font-normal text-sm leading-160";
    const inpErr = "w-full flex flex-col justify-center items-start px-4 py-2 static top-31.25 right-0 bottom-27.08 left-0 bg-transparent border border-solid border-red-336 box-border rounded-lg flex-none order-1 font-inter not-italic font-normal text-sm leading-160 placeholder-white-9EA"
